...
A research pass makes several model and web calls and routinely takes 30-60s. Without
feedback the terminal looks frozen, which is indistinguishable from a hang — and OpenRouter
latency here is spiky enough that real hangs happen too.
